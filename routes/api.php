...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['middleware' => ['auth:api', 'permission']], function () {
        ...
        Route::get('documentos/{documento}/empresa/{empresa_id}/consultar-estado-sii', 'V1\DocumentoAPIController@consultarEstadoSii')->name('documentos.consultar_estado_sii');
        Route::get('documentos/{documento}/empresa/{empresa_id}/consultar-estado-envio-sii', 'V1\DocumentoAPIController@consultarEstadoEnvioSii')->name('documentos.consultar_estado_envio_sii');
